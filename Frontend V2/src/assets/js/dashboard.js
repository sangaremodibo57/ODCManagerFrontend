(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      var salesTopData = {
          labels: ["JAN", "fev", "FEV","mar", "MAR", "avr", "AVR", "mai", "MAI","jui", "JUI","jul","JUL","aout", "AOUT","sept", "SEPT","oct", "OCT","nov", "NOV","dec", "DEC" ],
          datasets: [{
              label: 'This week',
              data: [0, 110, 200, 115, 130, 170, 90, 210, 130, 200, 115, 130, 170, 90, 210, 130, 130, 170, 90, 210, 130, 170, 90, 210],
              ...
              fill: true, // 3: no fill
              pointBorderWidth: 1,
              pointRadius: [4, 4, 4, 4, 4, 4, 4, 4, 4, 4,4, 4, 4, 4, 4, 4,4, 4, 4],
              pointHoverRadius: [2, 2, 2, 2, 2,2, 2, 2, 2, 2,2, 2, 2],
              pointBackgroundColor: ['#1F3BB3)', '#1F3BB3', '#1F3BB3', '#1F3BB3','#1F3BB3)', '#1F3BB3', '#1F3BB3', '#1F3BB3','#1F3BB3)', '#1F3BB3', '#1F3BB3', '#1F3BB3','#1F3BB3)'],
              pointBorderColor: ['#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff',],
          },{
            label: 'Last week',
            data: [0, 150, 190, 100, 120, 200, 230, 130, 170, 90, 210, 130, 200, 115, 130, 170,210, 130, 200, 115, 130, 0, 150, 190,],
